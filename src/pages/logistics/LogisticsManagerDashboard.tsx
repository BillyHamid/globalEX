...
import { Package, Truck, Warehouse, Users, Calendar, CheckCircle, XCircle, AlertTriangle, MapPin } from 'lucide-react';
...
export const LogisticsManagerDashboard = () => {
  ...
  // KPIs pour le gestionnaire logistique
  const kpis: KPI[] = [
    { 
    ...
    { 
      ...
      value: orders.filter(o => o.priority === 'urgent').length.toString(), 
      change: 5, 
      trend: 'up', 
      icon: 'AlertTriangle' 
    },
    { 
      ...
      value: stock.filter(s => s.available < s.threshold).length.toString(), 
      change: -2, 
      trend: 'down', 
      icon: 'AlertTriangle' 
    },
